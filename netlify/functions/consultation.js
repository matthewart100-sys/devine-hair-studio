...
const renderList = (payload) => {
  ...
  const desiredResults = Array.isArray(payload.desiredResultOptions)
    ? payload.desiredResultOptions.join(", ")
    : "None selected";
  ...
  return `
    ...
    <table cellpadding="8" cellspacing="0" style="border-collapse:collapse;width:100%;font-family:Arial,sans-serif;">
      ...
      <tr><td><strong>Availability Flexibility</strong></td><td>${escapeHtml(payload.availabilityFlexibility)}</td></tr>
      <tr><td><strong>Current Color</strong></td><td>${escapeHtml(payload.currentColor)}</td></tr>
      <tr><td><strong>Hair Length</strong></td><td>${escapeHtml(payload.hairLength)}</td></tr>
      ...
      <tr><td><strong>Desired Result Choices</strong></td><td>${escapeHtml(desiredResults || "None selected")}</td></tr>
      <tr><td><strong>Hair Goal</strong></td><td>${escapeHtml(payload.hairGoal)}</td></tr>
      <tr><td><strong>Budget Range</strong></td><td>${escapeHtml(payload.budgetRange || "Not provided")}</td></tr>
...
exports.handler = async (event) => {
  ...
  const fromEmail =
    ...
    "Devine Hair Studio <onboarding@resend.dev>";
  ...
  if (!response.ok) {
    ...
    console.error("Resend delivery failed", { fromEmail, detail });
    return json(502, {
      ok: false,
